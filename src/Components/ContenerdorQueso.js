...
import RectanguloNaranja from './ElementoInventario'

function ContenerdorQueso() {
  return (
    <>
        ...
        <div className="w-full bg-custom-orange flex justify-center text-center items-center rounded-t-xl mt-500">
          <p className="text-white text-3xl text-center font-bold">Quesos</p>
        </div>
...
export default ContenerdorQueso